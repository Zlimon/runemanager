...
class CreateThermonuclearSmokeDevilsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('thermonuclear_smoke_devils', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('thermonuclear_smoke_devils');
    }
}
