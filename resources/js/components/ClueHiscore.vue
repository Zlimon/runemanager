        ...
        <div v-else>
            ...
            <div v-else>
                <div class="d-flex flex-row">
                    <img :alt="meta.clue + ' icon'"
                         :src="'/images/clue/' + meta.clue + '.png'"
                    ...
                    <div class="col">
                        ...
                        <span>Total Caskets Opened: <strong>{{ meta.total_kills }}</strong></span>
                        <br>
                        <span>Average Caskets Opened: <strong>{{ meta.average_total_kills }}</strong></span>
                    </div>
                </div>
                                            ...
                                            <div v-for="(count, item) in hiscore.log"
                                                ...
                                                <div v-if="count === 1">
                                                    <img :alt="item + ' item icon'"
                                                         :src="'/images/clue/' + meta.clue + '/' + item + '.png'"
...
export default {
    ...
    mounted() {
        axios
            .get('/api/hiscore/clue/' + this.clue)
            .then((response) => {
