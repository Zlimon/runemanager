		...
		<div class="row justify-content-center">
			...
			<div class="main-page">
				...
				<div class="main-page-body">
					...
					@if ($member->user->private === 0)
						<p><span>Rank: <strong>{{ number_format($member->rank) }}</strong></span> | <span>Total XP: <strong>{{ number_format($member->xp) }}</strong></span> | <span>Total Level: <strong>{{ $member->level }}</strong></span></p>
