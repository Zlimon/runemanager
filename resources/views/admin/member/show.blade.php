        ...
        <div class="col-md-3 text-center">
            ...
            <form method="POST" action="{{ route('admin-show-member', $member->id) }}">
                ...
                <input id="user_id" type="text" class="form-control @error('user_id') is-invalid @enderror"
                       name="user_id" value="{{ old('user_id') }}" placeholder="Username or ID of new owner">
            ...
            <tr>
                <td>
                    <a href="{{ route('show-skill', Helper::listSkills()[$skillId]) }}">
                        <img src="{{ asset('images/skills/') }}/{{ ucfirst(Helper::listSkills()[$skillId]) }}.png"
                             width="35px" alt="{{ ucfirst(Helper::listSkills()[$skillId]) }} skill icon">
