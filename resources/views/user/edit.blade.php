					...
					<form method="POST" action="{{ route('update-user') }}">
								...
								<div class="form-check form-check-inline">
									<div class="icon-radio">
										<label class="icon-radio">
											...
											<img class="align" src="{{ asset('images') }}/friend.png" alt="Friend icon" title="Click here to show your account">
										</label>

										<label class="icon-radio">
											<input type="radio" name="private" id="privateTrue" value="1">
											<img class="align" src="{{ asset('images') }}/ignore.png" alt="Ignore icon" title="Click here to hide your account">
						...
						@if ($user->icon_id != null)
							<div class="form-group row">
								...
								<div class="col-md-6">
									<label class="icon-radio">
										<input type="radio" name="icon_id" id="icon_id" value="{{ $user->icon_id }}" onclick="fillText()" checked>
						...
						<div class="form-group row">
							...
							<div class="col-md-6">
								<div class="icon-radio">
									<input class="icon-select" type="radio" name="icon_id" id="icon-select" value="{{ $user->icon_id }}">
								</div>
