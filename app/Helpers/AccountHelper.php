...
class AccountHelper
{
     ...
     * @throws \Exception
     */
    public static function createOrUpdateAccount(string $accountUsername, User $user, AccountTypesEnum $accountType = AccountTypesEnum::NORMAL): Account
    {
        $playerData = self::getPlayerData(sprintf("https://secure.runescape.com/m=hiscore_oldschool/index_lite.ws?player=%s", urlencode($accountUsername)));
     ...
     * @return array
     */
    public static function getPlayerData(string $url): array
    {
     ...
     * @throws \Exception
     */
    public static function createOrUpdateAccountHiscores(Account $account, array $playerData): Account
    {
        DB::beginTransaction();
